...
See the [Setup page](https://qualiamachine.github.io/Intro_GCP_for_ML/setup.html) for instructions on preparing for this workshop.

## About

This lesson uses [The Carpentries Workbench][workbench] and is part of [The Carpentries Incubator](https://carpentries-incubator.org/).

## Contact

For questions or issues, contact [endemann@wisc.edu](mailto:endemann@wisc.edu) or open an issue on this repository.
