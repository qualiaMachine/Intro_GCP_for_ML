...
3. **Container choice**: We used `pytorch-xla.2-4.py310` for the CPU job and `pytorch-gpu.2-6` for the GPU job. What would happen if you used the CPU container but still passed `accelerator_type` and `accelerator_count`?
